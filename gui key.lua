...
local Window = Fluent:CreateWindow({
    Title = "Your Hub Name" .. Fluent.Version, 
    SubTitle = "by vloggerX",
...
function MakeScriptHub() 
  loadstring(game:HttpGet("https://pastebin.com/raw/3uYsvYRn"))() --Put Your Script
end
...
getgenv().Key = "Password" --Put Your Password
getgenv().KeyInput = "string" --???

    Tabs.Main:AddParagraph({
        Title = "Key System",
        Content = "Key Tutorial"
